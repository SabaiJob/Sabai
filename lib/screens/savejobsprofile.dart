...
class SaveJobsProfile extends StatefulWidget {
  const SaveJobsProfile({super.key});

  @override
  State<SaveJobsProfile> createState() => _SaveJobsProfileState();
}

class _SaveJobsProfileState extends State<SaveJobsProfile> {
